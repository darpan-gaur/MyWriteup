...
const Write = () => {
  ...
  const handleClick = async e=>{
    ...
    try{
      state ? await axios.put(`/api/posts/${state._id}`, {title, desc: value, cat, img: file ? imgUrl : ""
    ...
    <div className="writePage">
      ...
      <div className="menu">
        <div className="item">
          ...
          <label className='file' htmlFor="file">Upload Image</label>  {/* label represents input */}
